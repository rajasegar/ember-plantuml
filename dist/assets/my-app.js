...
;define("my-app/app", ["exports", "ember-resolver", "ember-load-initializers", "my-app/config/environment"], function (_exports, _emberResolver, _emberLoadInitializers, _environment) {
  "use strict";
...
;define("my-app/controllers/explore", ["exports"], function (_exports) {
  "use strict";
  ...
  class ExploreController extends Ember.Controller {
    constructor(...args) {
      super(...args);

      _defineProperty(this, "queryParams", ['path']);
  ...
  _exports.default = ExploreController;
});
;define("my-app/controllers/uml", ["exports"], function (_exports) {
  "use strict";
  ...
  class UmlController extends Ember.Controller {
    constructor(...args) {
      super(...args);

      _defineProperty(this, "queryParams", ['folder', 'path']);
    }

  }

  _exports.default = UmlController;
});
...
;define("my-app/helpers/app-version", ["exports", "my-app/config/environment", "ember-cli-app-version/utils/regexp"], function (_exports, _environment, _regexp) {
  "use strict";
...
;define("my-app/initializers/export-application-global", ["exports", "my-app/config/environment"], function (_exports, _environment) {
  "use strict";
...
;define("my-app/models/blog-post", ["exports", "@ember-data/model"], function (_exports, _model) {
  ...
  let BlogPostModel = (_dec = (0, _model.hasMany)('comment'), (_class = class BlogPostModel extends _model.default {
    constructor(...args) {
      super(...args);
...
;define("my-app/models/comment", ["exports", "@ember-data/model"], function (_exports, _model) {
  "use strict";
  ...
  let CommentModel = (_dec = (0, _model.belongsTo)('blog-post'), (_class = class CommentModel extends _model.default {
    constructor(...args) {
      super(...args);

      _initializerDefineProperty(this, "blogPost", _descriptor, this);
    }

  }, (_descriptor = _applyDecoratedDescriptor(_class.prototype, "blogPost", [_dec], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
...
;define("my-app/models/person", ["exports", "@ember-data/model"], function (_exports, _model) {
  "use strict";
  ...
  let PersonModel = (_dec = (0, _model.attr)('string'), _dec2 = (0, _model.attr)('number'), _dec3 = (0, _model.attr)('boolean'), _dec4 = (0, _model.attr)('date'), (_class = class PersonModel extends _model.default {
    constructor(...args) {
      super(...args);
      ...
      _initializerDefineProperty(this, "birthday", _descriptor4, this);
    }
    ...
    writable: true,
    initializer: null
  }), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "birthday", [_dec4], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  })), _class));
  _exports.default = PersonModel;
});
;define("my-app/models/profile", ["exports", "@ember-data/model"], function (_exports, _model) {
  "use strict";
  ...
  let ProfileModel = (_dec = (0, _model.belongsTo)('user'), (_class = class ProfileModel extends _model.default {
    constructor(...args) {
      super(...args);
...
;define("my-app/models/user", ["exports", "@ember-data/model"], function (_exports, _model) {
  "use strict";
  ...
  let UserModel = (_dec = (0, _model.belongsTo)('profile'), (_class = class UserModel extends _model.default {
    constructor(...args) {
      super(...args);
...
;define("my-app/router", ["exports", "my-app/config/environment"], function (_exports, _environment) {
  "use strict";
...
;define("my-app/routes/explore", ["exports"], function (_exports) {
  "use strict";
  ...
  class ExploreRoute extends Ember.Route {
    constructor(...args) {
      super(...args);
  ...
  _exports.default = ExploreRoute;
});
;define("my-app/routes/uml", ["exports"], function (_exports) {
  "use strict";
  ...
  class UmlRoute extends Ember.Route {
    constructor(...args) {
      super(...args);
    ...
    async model(params) {
      const unsafe = await fetch(`/uml?folder=${params.folder}&file=${params.file}`).then(res => res.json());
      const svg = Ember.String.htmlSafe(unsafe.svg);
      return {
        svg
      };
    }
...
;define("my-app/templates/application", ["exports"], function (_exports) {
  "use strict";
  ...
  var _default = Ember.HTMLBars.template({
    "id": "nF0jwDqK",
    "block": "[[[1,[28,[35,0],[\"Ember PlantUML\"],null]],[1,\"\\n\"],[10,\"header\"],[12],[1,\"\\n\"],[10,\"h1\"],[12],[1,\"Ember PlantUML\"],[13],[1,\"\\n\"],[13],[1,\"\\n\"],[10,0],[14,0,\"grid-col\"],[12],[1,\"\\n  \"],[10,\"aside\"],[12],[1,\"\\n    \"],[10,\"nav\"],[12],[1,\"\\n      \"],[10,\"ul\"],[12],[1,\"\\n        \"],[10,\"li\"],[12],[10,3],[14,6,\"/\"],[12],[1,\"Home\"],[13],[13],[1,\"\\n        \"],[10,\"li\"],[12],[8,[39,1],null,[[\"@route\",\"@query\"],[\"explore\",[28,[37,2],null,[[\"path\"],[\"app/components\"]]]]],[[\"default\"],[[[[1,\"Components\"]],[]]]]],[13],[1,\"\\n        \"],[10,\"li\"],[12],[8,[39,1],null,[[\"@route\",\"@query\"],[\"explore\",[28,[37,2],null,[[\"path\"],[\"app/models\"]]]]],[[\"default\"],[[[[1,\"Models\"]],[]]]]],[13],[1,\"\\n      \"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"],[13],[1,\"\\n  \"],[10,0],[12],[1,\"\\n\"],[46,[28,[37,4],null,null],null,null,null],[1,\"\\n  \"],[13],[1,\"\\n\"],[13],[1,\"\\n\"]],[],false,[\"page-title\",\"link-to\",\"hash\",\"component\",\"-outlet\"]]",
...
;define("my-app/templates/explore", ["exports"], function (_exports) {
  "use strict";
  ...
  var _default = Ember.HTMLBars.template({
    "id": "ZXWGqvMx",
    "block": "[[[1,[28,[35,0],[\"Explore\"],null]],[1,\"\\n\"],[10,\"h2\"],[12],[1,\"Explore\"],[13],[1,\"\\n\"],[1,[54,[[30,1]]]],[1,\"\\n\"],[10,\"ul\"],[12],[1,\"\\n\"],[42,[28,[37,3],[[28,[37,3],[[30,1,[\"files\"]]],null]],null],null,[[[1,\"  \"],[10,\"li\"],[12],[1,\"\\n  \"],[8,[39,4],null,[[\"@route\",\"@query\"],[\"uml\",[28,[37,5],null,[[\"folder\",\"file\"],[[30,1,[\"folder\"]],[30,2]]]]]],[[\"default\"],[[[[1,[30,2]]],[]]]]],[1,\"\\n  \"],[13],[1,\"\\n\"]],[2]],null],[13],[1,\"\\n\\n\"]],[\"@model\",\"file\"],false,[\"page-title\",\"log\",\"each\",\"-track-array\",\"link-to\",\"hash\"]]",
    "moduleName": "my-app/templates/explore.hbs",
    "isStrictMode": false
  });

  _exports.default = _default;
});
;define("my-app/templates/uml", ["exports"], function (_exports) {
  "use strict";
  ...
  var _default = Ember.HTMLBars.template({
    "id": "mHF1CAg5",
    "block": "[[[1,[28,[35,0],[\"Uml\"],null]],[1,\"\\n\"],[10,\"h2\"],[12],[1,\"Generate Uml\"],[13],[1,\"\\n\"],[1,[54,[[30,1]]]],[1,\"\\n\"],[10,0],[12],[1,\"\\n  \"],[1,[30,1,[\"svg\"]]],[1,\"\\n\"],[13],[1,\"\\n\"]],[\"@model\"],false,[\"page-title\",\"log\"]]",
    "moduleName": "my-app/templates/uml.hbs",
    "isStrictMode": false
  });
...
;
          if (!runningTests) {
            require("my-app/app")["default"].create({"name":"my-app","version":"0.0.0"});
          }
